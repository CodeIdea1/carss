...
window.onscroll = function () {
    ...
    let modernApp = document.querySelector('.modern-app');
    let modernTop = modernApp.offsetTop;
    let modernHeight = modernApp.offsetHeight;
    if (windowScrollTop > (modernTop + modernHeight - windowHeight -200 )) {
    ...
    if (windowScrollTop > (modernTop + modernHeight - windowHeight -600 )) {
    ...
    if (windowScrollTop > (vehicleTop + vehicleHeight - windowHeight -300 )) {
